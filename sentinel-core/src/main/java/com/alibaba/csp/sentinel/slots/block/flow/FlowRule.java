...
public class FlowRule extends AbstractRule {
     ...
     * if true,the rule will apply to all services.
     * if false,the rule will apply to a single service with ip below.
     */
    private boolean applyAll;

    /**
     * Especial machine ip address.
     */
    private String ip;

    /**
     * Service's port.Not special.
     */
    @Deprecated
